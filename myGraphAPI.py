...
## User
def list_users(access_token: str) -> dict:
    """列出所有用户
...
## Application
def list_owners(access_token: str, client_id: str) -> dict:
    """列出指定应用的拥有者
    :param access_token: 访问令牌
...
## To-do task list
def list_task_lists(access_token: str, user_id: str) -> dict:
    """列出所有任务列表
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :return: 整理后的返回结果
    """
    url = f"{HOST}/users/{user_id}/todo/lists"
    headers = {
        "Authorization": f"Bearer {access_token}"
    }
    return organize_result(response=requests.get(url=url, headers=headers), expected_status_code=200)

def create_task_list(access_token: str, user_id: str, data: dict) -> dict:
    """创建一个任务列表
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param data: 任务列表数据
...
def get_task_list(access_token: str, user_id: str, todoTaskListId:str) -> dict:
    """读取指定任务列表
    :param access_token: 访问令牌
    :param user_id: 用户ID
    ...
    :return: 整理后的返回结果
    """
    url = f"{HOST}/users/{user_id}/todo/lists/{todoTaskListId}"
    headers = {
        "Authorization": f"Bearer {access_token}"
    }
    return organize_result(response=requests.get(url=url, headers=headers), expected_status_code=200)

def update_task_list(access_token: str, user_id: str, todoTaskListId: str, data: dict) -> dict:
    """更新指定任务列表
    :param access_token: 访问令牌
    :param user_id: 用户ID
...
def delete_task_list(access_token: str, user_id: str, todoTaskListId:str) -> dict:
    """删除指定任务列表
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :todoTaskListId: 任务列表ID
...
## To-do task
def list_tasks(access_token: str, user_id: str, todoTaskListId: str) -> dict:
    """列出指定任务列表下的所有任务
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param todoTaskListId: 任务列表ID
    :return: 整理后的返回结果
    """
    url = f"{HOST}/users/{user_id}/todo/lists/{todoTaskListId}/tasks"
    headers = {
        "Authorization": f"Bearer {access_token}"
    }
    return organize_result(response=requests.get(url=url, headers=headers), expected_status_code=200)

def create_task(access_token: str, user_id: str, todoTaskListId: str, data: dict) -> dict:
    """创建一个指定任务列表下的任务
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param todoTaskListId: 任务列表ID
...
def get_task(access_token: str, user_id: str, todoTaskListId: str, taskId: str) -> dict:
    """读取指定任务列表下的指定任务
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param todoTaskListId: 任务列表ID
    ...
    :return: 整理后的返回结果
    """
    url = f"{HOST}/users/{user_id}/todo/lists/{todoTaskListId}/tasks/{taskId}"
    headers = {
        "Authorization": f"Bearer {access_token}"
    }
    return organize_result(response=requests.get(url=url, headers=headers), expected_status_code=200)

def update_task(access_token: str, user_id: str, todoTaskListId: str, taskId: str, data: dict) -> dict:
    """更新指定任务列表下的指定任务
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param todoTaskListId: 任务列表ID
...
def delete_task(access_token: str, user_id: str, todoTaskListId: str, taskId: str) -> dict:
    """删除指定任务列表下的指定任务
    :param access_token: 访问令牌
    :param user_id: 用户ID
    :param todoTaskListId: 任务列表ID
